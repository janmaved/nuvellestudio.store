...
INSERT OR IGNORE INTO settings (key, value) VALUES
  ...
  ('contact_email', 'care@nuvelle.com'),
...
INSERT OR IGNORE INTO products (name, description, category, subcategory, brand, price, compare_price, images, rating, reviews_count, featured, tags, stock) VALUES
  ('Velvet Matte Lipstick - Ruby Rose', 'Long-lasting velvet matte finish lipstick enriched with vitamin E. Non-drying, transfer-proof formula in a stunning ruby shade.', 'makeup', 'lips', 'Nuvéllé Beauty', 649, 999, '["https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=800","https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800"]', 4.8, 342, 1, 'bestseller,matte,lipstick', 150),
  ...
  ('HD Liquid Foundation - Natural', 'Buildable, full-coverage liquid foundation with SPF 20. Weightless feel with a natural luminous finish.', 'makeup', 'face', 'Nuvéllé Beauty', 899, 1299, '["https://images.unsplash.com/photo-1631730359585-38a4935cbec4?w=800"]', 4.5, 267, 0, 'foundation,face', 120),
